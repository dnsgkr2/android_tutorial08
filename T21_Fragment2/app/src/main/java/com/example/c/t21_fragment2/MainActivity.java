...
public class MainActivity extends ActionBarActivity {
    ...
    public void OnMyClick(View v){
        ...
        android.app.Fragment fr = fm.findFragmentById(R.id.frame);
        ...
        switch(v.getId()){
            case R.id.btnAdd:
                if(fr == null){
                    ...
                    Toast.makeText(this, " 이미 추가되어 있습니다.", Toast.LENGTH_LONG).show();
                }
                break;

            case R.id.btnRemove:
                if(fr == null){
                    Toast.makeText(this, " 프레그먼트가 없습니다.", Toast.LENGTH_LONG).show();
                }else{
                    FragmentTransaction tr = fm.beginTransaction();
                    tr.remove(fr);
                    tr.commit();
