    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch(id){
            case CUSTOM_DIALOG:
                ...
                customText.setText("customDialog - onCreate");
                return customdialog;
            ...
            case SHOW_DIALOG:
                ...
                builder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivity.this, "Destroy cancel", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        btnProgress1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final ProgressDialog dialog = ProgressDialog.show(
                        MainActivity.this, "Tilte", "Now Loading...",true, false);
